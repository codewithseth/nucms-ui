...
import { ReactComponent as Slide } from "../../../../../../_timouy/assets/svg/carousel-1.svg";
import { reqAddSlideShow, reqDeleteImage } from "../core/request";
import { removeImage } from "../core/reducer";
...
const TableBody = () => {
    ...
    const { images, loading } = useSelector(state => state.media);
    ...
    const handleSetSlideShow = (imageId) => {
        setSelectedSlide(imageId);
                ...
                <div className="grid grid-cols-4 gap-3 mt-5">
                    {loading ? (
                        ...
                        <div className="flex justify-center items-center col-span-4 w-full min-h-[100px]">
                            <div className="font-semibold text-xl">No media.</div>
                        </div>
                    )}
                </div>
            </Table.Body>
