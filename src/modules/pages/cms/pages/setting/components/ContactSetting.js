    ...
    return (
        <div className="px-4">
            ...
            <div className="flex justify-end items-end mt-4">
                <button className="bg-primary text-white hover:bg-sky-600 font-semibold text-[14px] py-2 px-5 border border-gray-400 rounded-lg shadow" onClick={handleUpload}>
                    Save
                </button>
            </div>
            {/* Site Profile */}
            <div className="gap-4">
                <div className="flex flex-col mt-6 md:flex-row md:items-start">
                    <div className="w-full md:w-1/2">
                        <div className="font-semibold text-black text-[17px] mb-4 md:mb-4">
                            Site Profile
                        </div>
                    </div>
            ...
            <div className="gap-4">
                <div className="flex flex-col mt-5 md:flex-row md:items-start">
                    <div className="w-full md:w-1/2">
                        <div className="font-semibold text-black text-[17px] mb-4 md:mb-0">
                            Contact information
                        </div>
                    </div>
            ...
            <div className="gap-4">
                <div className="flex flex-col mt-5 md:flex-row">
                    ...
                    <div className="w-full md:w-3/4 border rounded-xl p-5 mb-6">
                        <div className="font-semibold text-black text-[14px] mb-5">
                            Avatar
                        </div>
