          ...
          <Modal.Body>
            <Form>
              <div className="space-y-1">
                <CustomSelect label="Content" name="categoryId" placeholder="Please select a content" required>
                ...
                <InputForm label="Title" name="title" type="text" placeholder="Post title" required />
                <div className="mt-2">
