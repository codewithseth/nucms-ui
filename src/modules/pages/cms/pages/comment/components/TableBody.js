import { CheckCircleOutline, DeleteOutline, WarningAmberOutlined } from "@mui/icons-material";
    ...
    <div className="border rounded-xl mb-2">
      <div className="flex flex-col gap-4 px-5 pt-5 pb-2">
        <div className="flex gap-2 ">
          <img className="w-8 h-8 rounded-full" src={no_avartar} alt="user" />
          <div className="flex flex-col">
            <p className="text-sm text-gray-900 dark:text-white" role="none">
              {user}
            </p>
            <p className="text-xs text-opacity-50 text-gray-900 dark:text-white" role="none">
              {date}
            </p>
          </div>
        </div>
        <div className="flex flex-col gap-3">
          <div className="flex">
            <Post />
            <p className="ms-1 text-lg font-medium text-gray-900 dark:text-white">{title}</p>
          </div>
