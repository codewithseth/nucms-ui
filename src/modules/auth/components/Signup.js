            ...
            <div className="md:max-w-md w-full px-4 py-4 m-auto">
              ...
              <div className="w-auto">
                <InputForm
                  ...
                  disabled={loading}
                />
                <InputForm label="Email" name="email" type="email" placeholder="Enter your Email" disabled={loading} />
                <InputPassword label="Password" name="password" placeholder="Enter your Password" disabled={loading} />
                <InputPassword
